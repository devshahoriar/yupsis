...
export const products: Product[] = [
  ...
  },
  {
    ...
    price: 599.99,
    description:
      "High-performance 50mm f/1.4 lens for professional photography.",
    image:
  ...
  },
  {
    ...
    price: 79.99,
    description:
      "Portable waterproof Bluetooth speaker with rich sound and 12-hour battery.",
    image:
  ...
  },
  {
    ...
    price: 49.99,
    description:
      "Eco-friendly yoga mat with superior grip and cushioning for all yoga styles.",
    image:
  ...
  },
  {
    ...
    price: 149.99,
    description:
      "RGB backlit mechanical keyboard with blue switches for ultimate gaming experience.",
    image:
  ...
  },
  {
    ...
    price: 89.99,
    description:
      "Handcrafted genuine leather messenger bag perfect for work and travel.",
    image:
  ...
  },
  {
    ...
    price: 79.99,
    description:
      "Burr coffee grinder for perfectly ground coffee beans every time.",
    image:
  ...
  },
  {
    ...
    price: 19.99,
    description:
      "Adjustable aluminum smartphone stand for desk and nightstand use.",
    image:
  ...
  },
  {
    ...
    price: 34.99,
    description:
      "Sustainable bamboo cutting board with juice groove and non-slip feet.",
    image:
  ...
  },
  {
    ...
    price: 24.99,
    description:
      "Modern ceramic plant pot with drainage tray for indoor gardening.",
    image:
      "https://images.unsplash.com/photo-1485955900006-10f4d324d411?w=400&h=400&fit=crop&crop=center",
    category: "Home",
  },
  {
    id: 18,
    ...
    price: 29.99,
    description:
      "Complete resistance bands set with door anchor and workout guide.",
    image:
      "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=400&fit=crop&crop=center",
    category: "Fitness",
  },
  {
    ...
    price: 199.99,
    description:
      "Professional-grade stainless steel cookware set with non-stick coating.",
    image:
  ...
  },
  {
    ...
    price: 149.99,
    description:
      "WiFi-enabled digital photo frame with HD display and cloud storage.",
    image:
  ...
  },
  {
    ...
    price: 59.99,
    description:
      "Complete skincare routine set with cleanser, serum, and moisturizer.",
    image:
  ...
  },
  {
    ...
    price: 79.99,
    description:
      "Modern abstract wall art canvas print for contemporary home decor.",
    image:
  ...
  },
  {
    ...
    price: 89.99,
    description:
      "Professional Bluetooth headset with noise-canceling microphone for calls.",
    image:
